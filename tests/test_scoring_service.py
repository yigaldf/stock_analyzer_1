...
def test_compute_weighted_scores_ranks_best_first():
    ...
    stocks = [
        _metrics("A", forward_pe=10.0, peg_ratio=0.8, ev_to_ebitda=7.0,
                 revenue_growth_yoy=0.30, earnings_growth_yoy=0.25,
                 operating_margin=0.20, profit_margin=0.18,
                 roe=0.30, roa=0.15,
                 debt_to_equity=0.20, current_ratio=2.5,
                 levered_free_cash_flow=1.5e9, market_cap=20e9,
                 forward_dividend_yield=0.03),
        _metrics("B", forward_pe=20.0, peg_ratio=1.5, ev_to_ebitda=12.0,
                 revenue_growth_yoy=0.10, earnings_growth_yoy=0.05,
                 operating_margin=0.10, profit_margin=0.08,
                 roe=0.15, roa=0.08,
                 debt_to_equity=0.80, current_ratio=1.5,
                 levered_free_cash_flow=8e8, market_cap=20e9,
                 forward_dividend_yield=0.02),
        _metrics("C", forward_pe=30.0, peg_ratio=2.5, ev_to_ebitda=20.0,
                 revenue_growth_yoy=-0.05, earnings_growth_yoy=-0.10,
                 operating_margin=0.02, profit_margin=0.01,
                 roe=0.05, roa=0.02,
                 debt_to_equity=1.50, current_ratio=0.8,
                 levered_free_cash_flow=2e8, market_cap=20e9,
...
def test_compute_weighted_scores_weights_change_order():
    ...
    stocks = [
        _metrics("A", forward_pe=5.0, peg_ratio=0.5, ev_to_ebitda=5.0,
                 revenue_growth_yoy=0.05, earnings_growth_yoy=0.05,
                 operating_margin=0.10, profit_margin=0.10,
                 roe=0.10, roa=0.10,
                 debt_to_equity=0.50, current_ratio=1.5,
                 forward_dividend_yield=0.02),
        _metrics("B", forward_pe=50.0, peg_ratio=3.0, ev_to_ebitda=30.0,
                 revenue_growth_yoy=0.50, earnings_growth_yoy=0.50,
                 operating_margin=0.10, profit_margin=0.10,
                 roe=0.10, roa=0.10,
                 debt_to_equity=0.50, current_ratio=1.5,
                 forward_dividend_yield=0.02),
    ...
    val_heavy = {
        "valuation": 1.0, "growth": 0.0, "profitability": 0.0,
    ...
    growth_heavy = {
        "valuation": 0.0, "growth": 1.0, "profitability": 0.0,
        "capital_efficiency": 0.0, "health": 0.0, "cash_quality": 0.0,
        "valuation_trend": 0.0, "dividend": 0.0,
    }
...
def test_ties_broken_alphabetically():
    ...
    stocks = [
        _metrics("Z", forward_pe=10.0, peg_ratio=1.0, ev_to_ebitda=8.0,
                 revenue_growth_yoy=0.10, earnings_growth_yoy=0.10,
                 operating_margin=0.10, profit_margin=0.10,
                 roe=0.10, roa=0.10,
                 debt_to_equity=0.50, current_ratio=1.5,
                 forward_dividend_yield=0.02),
        _metrics("A", forward_pe=10.0, peg_ratio=1.0, ev_to_ebitda=8.0,
                 revenue_growth_yoy=0.10, earnings_growth_yoy=0.10,
                 operating_margin=0.10, profit_margin=0.10,
                 roe=0.10, roa=0.10,
                 debt_to_equity=0.50, current_ratio=1.5,
...
def test_weights_are_normalized_if_not_sum_to_one():
    stocks = [
        _metrics("A", forward_pe=10.0, peg_ratio=1.0, ev_to_ebitda=8.0,
                 ...
                 debt_to_equity=0.50, current_ratio=1.5,
                 forward_dividend_yield=0.02),
        _metrics("B", forward_pe=30.0, peg_ratio=2.0, ev_to_ebitda=15.0,
                 revenue_growth_yoy=0.05, earnings_growth_yoy=0.05,
                 operating_margin=0.05, profit_margin=0.05,
                 roe=0.05, roa=0.05,
                 debt_to_equity=1.00, current_ratio=1.0,
                 forward_dividend_yield=0.01),
    ]
